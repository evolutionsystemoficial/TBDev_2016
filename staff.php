            ...
            for($i = 0; $i < $cols; $i++)
            {
             ...
             $htmlout .= "
                       <div class='staff_info'>
                           <span class='bold'><font color='#".get_user_class_color($staff[$r]['class'])."'><b>".htmlsafechars($staff[$r]['username'])."</b></font></span>&nbsp;<img src='{$TBDEV['baseurl']}/templates/1/images/".($staff[$r]['last_access']>$dt?"/user_green.png":"/user_off.png" )."' alt='' /><br />
