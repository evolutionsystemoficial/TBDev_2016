...
loggedinorreturn();
    ...
    ****************/
    ...
    $HTMLOUT .= "<fieldset>
    <legend><strong>{$lang['my_shoutback']}</strong></legend>
    <label><input type='radio' name='shoutboxbg'" . ($CURUSER["shoutboxbg"] == "1" ? " checked='checked'" : "") . " value='1' />{$lang['my_shoutback_white']}
    <input type='radio' name='shoutboxbg'" . ($CURUSER["shoutboxbg"] == "2" ? " checked='checked'" : "") . " value='2' />{$lang['my_shoutback_grey']}<input type='radio' name='shoutboxbg'" . ($CURUSER["shoutboxbg"] == "3" ? " checked='checked'" : "") . " value='3' />{$lang['my_shoutback_black']}</label>
    </fieldset>
   </fieldset>";
